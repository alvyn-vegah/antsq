            ...
            <div className='min-h-[90vh] flex flex-col md:flex-row px-10 md:px-20 md:pl-20 md:pr-5 py-10 relative'>
                ...
                <div className="flex flex-col justify-around items-center md:items-start gap-10 w-full md:w-1/2">
                  <div className="flex flex-col items-center md:items-start gap-5">
                    <p ref={ref1} className="text-red-700 text-lg 2xl:text-3xl font-semibold hidden md:block text-center md:text-left">{props.data.popupText}</p>
                    <p className="font-bold text-4xl md:text-5xl 2xl:text-7xl text-center md:text-left" style={{letterSpacing:"4px"}}>{props.data.title}</p>                  </div>
                 <Link
                   href="/plans-pricing"
                   className={[
                     "rounded-full font-montserrat font-semibold shadow-amber-800 shadow-md text-white 2xl:text-2xl w-fit text-xl z-20 flex gap-1 items-center px-10 sm:py-2 md:py-5 transition-transform duration-300",
