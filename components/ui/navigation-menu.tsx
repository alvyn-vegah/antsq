...
function NavigationMenu({
  ...
  return (
    <NavigationMenuPrimitive.Root
      ...
      className={cn(
        "group/navigation-menu relative flex flex-1 items-center justify-around px-7 w-[100vw]",
        className
      )}
      {...props}
    >
...
function NavigationMenuItem({
  ...
  return (
    <NavigationMenuPrimitive.Item
      ...
      className={cn("relative h-full py-2", className)}
      {...props}
    />
  )
}
...
function NavigationMenuContent({
  ...
  return (
    <NavigationMenuPrimitive.Content
      ...
      className={cn(
        "absolute top-[50px] left-0 w-full p-0 pr-0 md:w-[300px] z-50",
